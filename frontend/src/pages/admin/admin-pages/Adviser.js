...
const Adviser = () => {
    ...
    const handleSelect = (data) => {
        ...
        alert('Selected recommended system');
    };
    ...
    const handleSendEmail = async (e) => {
        ...
        if (selectedData !== null) {
            ...
            alert('Please select recommended system')
        }
    };
    ...
    return (
        <div className={"adviserContainer"}>
            <Box height={100}/>
            <div>
                <Box component="main" sx={{flexGrow: 1, bgcolor: "white", p: 1}}>
                    ...
                    <ul>
                        {recommandData && recommandData.map((data, index) => (
                            <li key={index} onClick={() => handleSelect(data)} style={{cursor: 'pointer'}}>
                                {data}
                            </li>
                        ))}
                    </ul>
