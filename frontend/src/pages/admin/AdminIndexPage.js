...
export const ClientLogo = () => (
    <Icon>
        <img src={require('../../assets/icon/man.png')} height={25} width={25} alt={'icon'}/>
    </Icon>
)
export const DashIcon = () => (
    <Icon>
        <img src={require('../../assets/icon/dashboard.png')} height={25} width={25} alt={'icon'}/>
    </Icon>
)
        ...
        <Box sx={{display: 'flex'}}>
            ...
            <Drawer variant="permanent" open={open}>
                ...
                <List>
                    ...
                    <ListItem disablePadding sx={{display: "block"}} onClick={() => setMenuData("AdviserPage")}>
                        <ListItemButton
                            sx={{
                                minHeight: 48,
                                justifyContent: open ? "initial" : "center",
